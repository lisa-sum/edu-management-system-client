...
tar -czvf dist.tgz --exclude=node_modules -C "$CI_PROJECT_DIR"/web/client/dist . --remove-files
...
sshpass -e ssh -o stricthostkeychecking=no root@47.120.5.83 'cd /home/nginx/html/temp && bash dir.sh && ls /home/nginx/html/web && tar -xzvf dist.tgz -C /home/nginx/html/web && rm -rf /home/nginx/html/temp'
